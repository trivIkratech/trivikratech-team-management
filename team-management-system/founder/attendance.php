...
if (!empty($filterDate)) {
    $where = ["u.role IN ({$roleInSql})", "u.status = 'active'", "COALESCE(u.joining_date, DATE(u.created_at)) <= ?"];
    ...
    $dataQuery = "
        SELECT u.id as user_id, u.name, u.email, u.role, u.designation, u.employee_id, u.joining_date, u.created_at,
...
<?php else: ?>
    <div class="table-container">
        <table class="data-table">
            <thead>
                <tr>
                    <th style="min-width: 230px;">User / Staff</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            if ($record['role'] === ROLE_MANAGER) {
                                echo '<span class="badge badge-purple" style="font-weight: 600;">Manager</span>';
                            } elseif ($record['role'] === ROLE_HR) {
                                echo '<span class="badge badge-info" style="font-weight: 600;">HR</span>';
                            } else {
                                echo '<span class="badge badge-secondary" style="font-weight: 600;">Employee</span>';
                            }
                            ?>
                        </td>
